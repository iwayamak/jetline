...
class TimeUtil(object):
    ...
    @classmethod
    def datetime_object_from_yyyymmdd_str(cls, tstr: str) -> str:
    ...
    @classmethod
    def datetime_list(cls, fr_str_yyyymmdd: str, to_str_yyyymmdd: str) -> str:
        dt_lst = []
        if not to_str_yyyymmdd:
            dt_lst.append(
    ...
    def datetime_delta(cls, target_date: datetime, years: int=0, months: int=0, days: int=0, leapdays: int=0,
                       weeks: int=0, hours: int=0, minutes: int=0, seconds: int=0, microseconds: int=0) -> datetime:
